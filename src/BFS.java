 ...
 */
public class BFS extends AbstractAction {
    ...
    public BFS(String text, String[][] strings) {
        button_bfs = new JButton();
        this.strings = strings;
        button_bfs.setAction(this);
        putValue(NAME, text);
    }

    public JButton getButton_bfs() {
        return button_bfs;
    }
    ...
    public JFrame create_window () {
        window2 = new JFrame("Lights Out : BFS-solved");
    ...
    public State BFS(State init_state) {
        ...
        while(!frontier.isEmpty()) {
            State current = new State(frontier.removeFirst());
            ...
            if(current.goal_test()) return current;
                ...
                for(Point p : current.actions()) {
                    ...
                    frontier.*/
                    frontier.add(current2.result(p));
                }
            }
        }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        try {
            ...
            //the BFS method returns the last possible state, which is the win state.
            ...
            if(final_state == null) {
                ...
                for(Point p : final_toggle) {
                    ...
                    array[(int) p.getY()][(int) p.getX()].set_state(0);
                }
            }
        }
    }
